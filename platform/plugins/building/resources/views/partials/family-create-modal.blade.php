...
<div v-if="openFamilyCreateModal==1" id="familyCreateModalOverlay" style="
...
position: relative;padding: 18px;box-shadow: rgba(0, 0, 0, 0.25) 0px 8px 24px;">
    <div id="familyCreateModal" style="background: rgb(255, 255, 255);
    width: 90%;
    max-width: 720px;
    max-height: 92vh;
    overflow: auto;
    ...
    transform: translate(-50%);">
        <span id="familyCreateModalClose" style="position:absolute;top:10px;right:14px;font-size:28px;color:#888;cursor:pointer;user-select:none">×</span>

        <h3 style="margin:0 0 12px">Create Family</h3>
        ...
        <form id="familyCreateForm" method="POST" action="{{ route('family.store') }}">
            ...
            <div style="margin-top:16px;text-align:right">
                <button type="button" id="btnFamilyCancel" class="btn btn-secondary" style="margin-right:8px">Cancel</button>
                <button type="submit" id="btnFamilySave" class="btn btn-primary">Save Family</button>
            </div>
        </form>
    </div>
</div>
